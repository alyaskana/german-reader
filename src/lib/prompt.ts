...
- Добавь поле "cover": обложка истории — inline SVG одной строкой. Плоская минималистичная иллюстрация по сюжету (1–2 узнаваемых предмета из истории, вид «плоской иконки», без людей и без текста). Технически: viewBox='0 0 200 120', preserveAspectRatio='xMidYMid slice', атрибуты в ОДИНАРНЫХ кавычках, 6–15 простых фигур (rect, circle, ellipse, path), без градиентов, script, image, use и внешних ссылок. Палитра (используй только эти цвета): фон #f6efe4, полоса земли/стола #eaddc6, тёмный #2c2825, приглушённый серый #8a827a, акцент #d9534f, охра #e8c07d, шалфей #a8b894, пыльно-синий #7d95a8, белый #ffffff.
...
Ответь ТОЛЬКО валидным JSON в этом формате (без markdown-обёртки):
{
  ...
  "cover": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 120'>...</svg>"
}
