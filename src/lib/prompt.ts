...
- Добавь поле "nouns": объект «существительное → словарная форма». Ключ — форма слова, как она встречается в тексте, в нижнем регистре (и ед., и мн. числа, если в тексте встречаются обе — добавь оба ключа). Значение единообразно: «ед.ч. с артиклем · мн.ч.», напр. "kind": "das Kind · die Kinder", "kinder": "das Kind · die Kinder", "decke": "die Decke · die Decken". У несчётных (Wasser, Angst — мн.ч. нет) и pluralia tantum (Eltern, Ferien — ед.ч. нет) одна форма: "das Wasser", "die Eltern". Без имён собственных.
...
const JSON_FORMAT = `Ответь ТОЛЬКО валидным JSON в этом формате (без markdown-обёртки):
{
  ...
  "nouns": {"decke": "die Decke · die Decken", "kinder": "das Kind · die Kinder"},
