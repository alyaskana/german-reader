...
- **Чтение с глоссами** — переводы у сложных слов; режим «по тапу» для самопроверки.
- **Мои слова** — тапни слово → «+ В мои слова», собирай личный словарик.
- **Тренировка слов** — флешкарточки с интервальным повторением (не помню / помню / легко). Слово с интервалом от 21 дня считается выученным и перестаёт подсвечиваться в текстах.
